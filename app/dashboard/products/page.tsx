        ...
        <>
            ...
            <Card className="mt-6">
                <CardHeader>
                    ...
                    <CardDescription>Manage your products and view their sales stats.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
                        ...
                        <TableBody>
                            {data.map((item) => (
                                ...
                                <TableCell>
                                    <Image alt={item.name} src={item.images[0]} width={64} height={64}
                                ...
                                <TableCell>
                                   {new Intl.DateTimeFormat("ka-GE").format(item.createdAt)}
                                </TableCell>
                                ...
                                <TableCell className="text-end">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            <DropdownMenuItem className="cursor-pointer hover:bg-slate-300" asChild> 
